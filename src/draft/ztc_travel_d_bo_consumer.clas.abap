"! <p class="shorttext synchronized" lang="en">ZR_TRAVEL_D consumer as code under test for RAP BO TDF</p>
"! A consumer of ZR_TRAVEL_D BO for demonstration of RAP BO Test double framework which is used as code under test.<br/>
"! The consumer methods has EML statements with draft instances, as dependency on ZR_TRAVEL_D BO, which can be isolated using RAP BO test double framework.<br/><br/>
"! Check test classes from {@link ZTC_BOTD_TRAVEL_D_DEMOS} for demos.
CLASS ztc_travel_d_bo_consumer DEFINITION
  ...
  PUBLIC SECTION.
  types:
    failed_travel_type type response for failed early ZR_TRAVEL_D .
  types:
    reported_travel_type type response for reported early ZR_TRAVEL_D .
  types:
    mapped_travel_type type response for mapped early ZR_TRAVEL_D .
  types:
  ""MODIFY
    create_travel_input_type type table for create ZR_TRAVEL_D .
  types:
    create_booking_by_assoc_in_typ type table for create ZR_TRAVEL_D\_Booking .
  types:
    update_travel_input_type type table for update ZR_TRAVEL_D .
  types:
    update_booking_input_type type table for update ZR_TRAVEL_D\\BOOKING .
  types:
    delete_travel_input_type type table for delete ZR_TRAVEL_D .
  types:
    accept_travel_act_in_type type table for action import  ZR_TRAVEL_D~acceptTravel .
  types:
    accept_travel_act_res_type type table for action result  ZR_TRAVEL_D~acceptTravel .
  types:
    deduct_discount_act_in_type type table for action import  ZR_TRAVEL_D~deductDiscount .
  types:
    deduct_discount_act_res_type type table for action result  ZR_TRAVEL_D~deductDiscount .

  types:
  ""READ
    read_travel_input_type type table for read import ZR_TRAVEL_D .
  types:
    read_booking_by_assoc_in_typ type table for read import ZR_TRAVEL_D\_Booking .
  types:
    read_travel_result_type type table for read result ZR_TRAVEL_D .
  types:
    read_booking_by_assoc_res_typ type table for read result ZR_TRAVEL_D\_Booking .
  types:
    read_booking_by_assoc_link_typ type table for read link ZR_TRAVEL_D\_Booking .
...
CLASS ztc_travel_d_bo_consumer IMPLEMENTATION.
