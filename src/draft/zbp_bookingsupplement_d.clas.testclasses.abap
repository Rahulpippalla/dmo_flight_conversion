"! @testing BDEF:ZR_BookingSupplement_D
...
CLASS ltc_BookingSupplement IMPLEMENTATION.
  ...
  METHOD calculatetotalprice.
    ...
    cl_abap_unit_assert=>assert_equals(
        exp = CONV ztotal_price( c_supplement_price * lines( bookingsupplement_mock_data ) )
  ...
  METHOD validateSupplement_success.
    CONSTANTS:
      c_supplement_id TYPE zsupplement_id VALUE '123'.
  ...
  METHOD validateSupplement_initial.
    CONSTANTS:
      c_supplement_id            TYPE zsupplement_id VALUE '123',
      c_supplement_id_of_booking TYPE zsupplement_id VALUE '111'.
  ...
  METHOD validateSupplement_not_exist.
    CONSTANTS:
      c_supplement_id            TYPE zsupplement_id VALUE '123',
      c_supplement_id_of_booking TYPE zsupplement_id VALUE IS INITIAL.
