...
CLASS ltc_travel IMPLEMENTATION.
  ...
  METHOD accepttravel.
    DATA:
      ...
      result             TYPE TABLE FOR ACTION RESULT  ZR_Travel_D\\Travel~acceptTravel,
      mapped             TYPE RESPONSE FOR MAPPED EARLY  ZR_Travel_D,
      failed             TYPE RESPONSE FOR FAILED EARLY  ZR_Travel_D,
      reported           TYPE RESPONSE FOR REPORTED EARLY  ZR_Travel_D.
  ...
  METHOD rejecttravel.
    DATA:
      ...
      exp_travel_read    TYPE STRUCTURE FOR READ RESULT ZR_Travel_D\\travel,
      result             TYPE TABLE FOR ACTION RESULT  ZR_Travel_D\\Travel~rejectTravel,
      mapped             TYPE RESPONSE FOR MAPPED EARLY  ZR_Travel_D,
      failed             TYPE RESPONSE FOR FAILED EARLY  ZR_Travel_D,
      reported           TYPE RESPONSE FOR REPORTED EARLY  ZR_Travel_D.
  ...
  METHOD deductdiscount_invalid_param.
    TYPES:
      t_keys TYPE TABLE FOR KEY OF ZR_Travel_D\\Travel.
    DATA:
      travels_to_test TYPE TABLE FOR ACTION IMPORT ZR_Travel_D\\travel~deductDiscount,
      result          TYPE TABLE FOR ACTION RESULT  ZR_Travel_D\\Travel~deductDiscount,
      mapped          TYPE RESPONSE FOR MAPPED EARLY  ZR_Travel_D,
      failed          TYPE RESPONSE FOR FAILED EARLY  ZR_Travel_D,
      reported        TYPE RESPONSE FOR REPORTED EARLY  ZR_Travel_D.
  ...
  METHOD get_instance_features.
    TYPES: t_instance_feature TYPE STRUCTURE FOR INSTANCE FEATURES RESULT ZR_Travel_D\\travel,
           BEGIN OF t_check.
             INCLUDE TYPE t_instance_feature.
    TYPES: overallstatus TYPE ZR_Travel_D-OverallStatus,
           END OF t_check,
    ...
    DATA:
      ...
      exp_result         TYPE TABLE FOR INSTANCE FEATURES RESULT ZR_Travel_D\\travel,
      reported           TYPE RESPONSE FOR REPORTED EARLY ZR_Travel_D,
      failed             TYPE RESPONSE FOR FAILED   EARLY ZR_Travel_D.
  ...
  METHOD get_global_authorizations.
    DATA:
      requested_authorizations TYPE STRUCTURE FOR GLOBAL AUTHORIZATION REQUEST ZR_Travel_D\\travel,
      exp_result               TYPE STRUCTURE FOR GLOBAL AUTHORIZATION RESULT ZR_Travel_D\\travel,
      act_result               TYPE STRUCTURE FOR GLOBAL AUTHORIZATION RESULT ZR_Travel_D\\travel,
      reported                 TYPE RESPONSE FOR REPORTED EARLY ZR_Travel_D.
  ...
  METHOD get_instance_authorizations.
    CONSTANTS:
      c_agency1    TYPE zagency_id VALUE '1337',
      c_agency2    TYPE zagency_id VALUE '1338',
      c_country_de TYPE zagency-country_code VALUE 'US' ##NO_TEXT,
    ...
    DATA:
      ...
      act_result               TYPE TABLE FOR AUTHORIZATION RESULT ZR_Travel_D\\travel,
      exp_result               TYPE TABLE FOR AUTHORIZATION RESULT ZR_Travel_D\\travel,
      failed                   TYPE RESPONSE FOR FAILED EARLY ZR_Travel_D,
      reported                 TYPE RESPONSE FOR REPORTED EARLY ZR_Travel_D.
  ...
  METHOD resume_success.
    ...
    DATA:
      ...
      failed           TYPE RESPONSE FOR FAILED EARLY ZR_Travel_D,
      reported         TYPE RESPONSE FOR REPORTED EARLY ZR_Travel_D,
      mapped           TYPE RESPONSE FOR MAPPED zr_travel_d.
