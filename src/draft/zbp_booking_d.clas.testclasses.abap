...
CLASS ltc_booking IMPLEMENTATION.
  ...
  METHOD validatecustomer_initial.
    CONSTANTS:
      c_customer_id            TYPE zcustomer_id VALUE '123',
      c_customer_id_of_booking TYPE zcustomer_id VALUE '111'.
  ...
  METHOD validatecustomer_not_exist.
    CONSTANTS:
      c_customer_id            TYPE zcustomer_id VALUE '123',
      c_customer_id_of_booking TYPE zcustomer_id VALUE IS INITIAL.
  ...
  METHOD validateConnection_success.
    CONSTANTS:
      c_airline TYPE zcarrier_id VALUE 'TS',
      c_connection TYPE zconnection_id VALUE '123',
      c_flight_date TYPE zflight_date VALUE '20200202'.
  ...
  METHOD validateConnection_not_exist.
    CONSTANTS:
      c_airline TYPE zcarrier_id VALUE 'TS',
      c_connection TYPE zconnection_id VALUE '123',
      c_connection_not_exist TYPE zconnection_id VALUE '321',
      c_flight_date TYPE zflight_date VALUE '20200202'.
