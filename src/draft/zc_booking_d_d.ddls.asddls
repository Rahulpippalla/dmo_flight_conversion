  ...
  as projection on ZRBooking_D
{
  key BookingUUID,
      ...
      @Consumption.valueHelpDefinition: [ 
          { entity: {name: 'ZI_Flight_StdVH', element: 'Price'},
      ...
      /* Associations */
      _BookingSupplement: redirected to composition child ZC_BookingSupplement_D_D,
      _BookingStatus,
      _Carrier,
      _Connection,
      _Customer,
      _Travel: redirected to parent ZC_Travel_D_D
}
