"! <p class="shorttext synchronized" lang="en">ZI_TRAVEL_M consumer as code under test for RAP BO TDF</p>
"! A consumer of ZI_TRAVEL_M BO for demonstration of RAP BO Test double framework which is used as code under test.<br/>
"! The consumer methods has EML statements as dependency on ZI_TRAVEL_M BO, which can be isolated using RAP BO test double framework.<br/><br/>
"! Check test classes from {@link ZTC_BOTD_TRAVEL_M_DEMOS} for demos.
CLASS ztc_travel_m_bo_consumer DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
  types:
    failed_travel_type type response for failed early ZI_TRAVEL_M .
  types:
    reported_travel_type type response for reported early ZI_TRAVEL_M .
  types:
    mapped_travel_type type response for mapped early ZI_TRAVEL_M .
  types:
  ""MODIFY
    create_travel_input_type type table for create ZI_TRAVEL_M .
  types:
    create_booking_by_assoc_in_typ type table for create ZI_TRAVEL_M\_Booking .
  types:
    update_travel_input_type type table for update ZI_TRAVEL_M .
  types:
    delete_travel_input_type type table for delete ZI_TRAVEL_M .
  types:
    update_booking_input_type type table for update ZI_TRAVEL_M\\BOOKING .
  types:
    accept_travel_act_in_type type table for action import  ZI_TRAVEL_M~acceptTravel .
  types:
    accept_travel_act_res_type type table for action result  ZI_TRAVEL_M~acceptTravel .
  types:
  ""READ
    read_travel_input_type type table for read import ZI_TRAVEL_M .
  types:
    read_booking_by_assoc_in_typ type table for read import ZI_TRAVEL_M\_Booking .
  types:
    read_travel_result_type type table for read result ZI_TRAVEL_M .
  types:
    read_booking_by_assoc_res_typ type table for read result ZI_TRAVEL_M\_Booking .
  types:
    read_booking_by_assoc_link_typ type table for read link ZI_TRAVEL_M\_Booking .
...
CLASS ztc_travel_m_bo_consumer IMPLEMENTATION.
