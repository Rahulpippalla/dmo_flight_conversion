...
CLASS ztc_travel_m IMPLEMENTATION.
  ...
  METHOD create_validation_negative.
    ...
    cl_abap_unit_assert=>assert_equals( exp = 'ZCM_FLIGHT' act = reported_commit-travel[ 1 ]-%msg->if_t100_message~t100key-msgid ).
  ...
  METHOD create_additional_save.
    ...
    SELECT changed_field_name FROM zlog_travel WHERE changing_operation = 'CREATE' ORDER BY changed_field_name  INTO TABLE @DATA(log_fields).
