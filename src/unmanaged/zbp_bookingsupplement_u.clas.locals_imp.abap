...
**********************************************************************
  METHOD update.
    DATA: messages         TYPE zt_message,
          book_supplements TYPE zbook_suppl.
      ...
      CALL FUNCTION 'ZFLIGHT_TRAVEL_UPDATE'
        EXPORTING
          ...
          it_booking_supplement  = VALUE zt_booking_supplement_in( (  booking_supplement_id = <bookingsupplement>-bookingSupplementid
                                                                          booking_id            = <bookingsupplement>-BookingID ) )
          it_booking_supplementx = VALUE zt_booking_supplement_inx( ( booking_supplement_id = <bookingsupplement>-bookingsupplementid
                                                                          booking_id            = <bookingsupplement>-bookingid
...
**********************************************************************
  METHOD read.
    ...
    DATA: booksuppls_out TYPE zt_booking_supplement,
          messages       TYPE zt_message.
...
**********************************************************************
  METHOD rba_Booking.
    DATA: booking_out TYPE zt_booking,
