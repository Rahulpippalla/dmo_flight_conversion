...
********************************************************************************
  METHOD get_instance_features.
    READ ENTITIES OF ZI_Travel_U IN LOCAL MODE
      ENTITY Travel
...
**********************************************************************
  METHOD create.
    DATA: messages   TYPE zt_message,
          travel_in  TYPE ztravel,
          travel_out TYPE ztravel.
...
**********************************************************************
  METHOD lock.
    TRY.
        ...
        DATA(lock) = cl_abap_lock_object_factory=>get_instance( iv_name = 'ZETRAVEL' ).
...
**********************************************************************
  METHOD cba_Booking.
    DATA: messages        TYPE zt_message,
          booking_old     TYPE zt_booking,
          booking         TYPE zbooking,
          last_booking_id TYPE zbooking_id VALUE '0'.
...
CLASS lsc_I_TRAVEL_U IMPLEMENTATION.
  ...
  METHOD adjust_numbers.
    ...
    DATA: travel_mapping       TYPE zif_flight_legacy=>tt_ln_travel_mapping,
