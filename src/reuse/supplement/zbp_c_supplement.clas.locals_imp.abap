...
CLASS lhc_Supplement IMPLEMENTATION.
  ...
  METHOD augment.
    ...
    DATA: suppltext_for_new_suppl      TYPE TABLE FOR CREATE ZI_Supplement\_SupplementText,
          suppltext_for_existing_suppl TYPE TABLE FOR CREATE ZI_Supplement\_SupplementText,
          supplementtext_update        TYPE TABLE FOR UPDATE ZI_SupplementText.
    ...
    DATA: suppl_text_tky_link TYPE STRUCTURE FOR READ LINK ZI_Supplement\\Supplement\_SupplementText,
    ...
    MODIFY AUGMENTING ENTITIES OF ZI_Supplement
      ENTITY Supplement
    ...
    IF entities_update IS NOT INITIAL.
      ...
      READ ENTITIES OF ZI_Supplement
