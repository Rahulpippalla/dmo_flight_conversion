CLASS zcx_flight_legacy DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE 'ZCM_FLIGHT_LEGAC',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE 'ZCM_FLIGHT_LEGAC',
...
CLASS zcx_flight_legacy IMPLEMENTATION.
